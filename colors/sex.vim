...
set background=dark
set t_Co=256
hi Normal guifg=#d81b60 ctermbg=NONE guibg=#412d38 gui=NONE
...
hi Pmenu guifg=#d81b60 guibg=#412d38
hi SignColumn guibg=#412d38
hi Title guifg=#d81b60
hi LineNr guifg=#23040f guibg=#412d38
hi NonText guifg=#c481ff guibg=#412d38
hi Comment guifg=#c481ff gui=italic
hi SpecialComment guifg=#c481ff gui=italic guibg=#412d38
hi CursorLine guibg=#412d38
hi TabLineFill gui=NONE guibg=#412d38
hi TabLine guifg=#23040f guibg=#412d38 gui=NONE
hi StatusLine gui=bold guibg=#412d38 guifg=#d81b60
hi StatusLineNC gui=NONE guibg=#412d38 guifg=#d81b60
hi Search guibg=#c481ff guifg=#d81b60
hi VertSplit gui=NONE guifg=#412d38 guibg=NONE
hi Visual gui=NONE guibg=#412d38
